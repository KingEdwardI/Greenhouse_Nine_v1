...
export const FileManager = () => (
  <div style={{ padding: '2rem', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <ContextMenu
  ...
  <div style={{ padding: '2rem' }}>
    <p>
      ...
      <ContextMenu
        ...
        onItemSelect={(itemId) => alert(`Selected: ${itemId}`)}
      >
        <span style={{ background: 'var(--yellow-3)', padding: '2px 4px', borderRadius: 'var(--radius-1)' }}>
