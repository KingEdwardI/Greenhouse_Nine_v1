...
import { DotMatrixSpiralSpinner } from "./DotMatrixSpiralSpinner";
import type { DotMatrixSpiralSpinnerProps } from "./DotMatrixSpiralSpinner";
import { colors } from "../../tokens/colors";

export default {
  title: "Feedback/DotMatrixSpiralSpinner",
};
...
export const InContext: Story = () => (
  ...
  >
    ...
    >
      <DotMatrixSpiralSpinner size="md" color={colors.primary} />
    ...
    >
      <DotMatrixSpiralSpinner size="sm" speed={8} color={colors.secondary} />
    </div>
  </div>
);
