    ...
    return (
        <Drawer open={open} onOpenChange={setOpen}>
            ...
            <Drawer.Content title="Edit Profile">
                <div style={{ padding: 'var(--space-4) 0', height: '100%', display: 'flex', flexDirection: 'column' }}>
                    <Flex direction="column" gap="4" height="100%">
                        ...
                        <Flex direction="column" gap="3" flexGrow="1">
                            <div>
                                ...
                                <TextField.Root placeholder="Enter your full name" defaultValue="Pedro Duarte" />
                            </div>
                            ...
                            <div>
                                ...
                                <TextField.Root placeholder="Enter username" defaultValue="@peduarte" />
                            </div>
                        </Flex>

                        <Flex gap="3" justify="end" pt="4" borderTop="1px solid var(--gray-a4)">
                            ...
                            <Flex direction="column" gap="4" height="100%">
                                <div>
                                    ...
                                    <div style={{
                                        ...
                                        <Text size="2" color="gray">Content Area</Text>
                                    </div>
                                </div>
        ...
        <Drawer open={open} onOpenChange={setOpen}>
            ...
            <Drawer.Content title="Glass Effect" glass>
                <div style={{ padding: 'var(--space-4) 0', height: '100%', display: 'flex', flexDirection: 'column' }}>
                    <Flex direction="column" gap="4" height="100%">
                        <Text as="p" size="2" color="gray">
                            This drawer features the glassmorphism effect with blur and transparency for a modern look.
                        </Text>
                        ...
                        <Flex direction="column" gap="3" flexGrow="1">
                            ...
                            <div>
                                ...
                                <TextField.Root type="email" placeholder="Enter email" defaultValue="pedro@example.com" />
                            </div>
                        </Flex>

                        <Flex gap="3" justify="end" pt="4" borderTop="1px solid rgba(255, 255, 255, 0.1)">
                            <Drawer.Close asChild>
                                <Button variant="soft" color="gray">
                                    Cancel
                                </Button>
                    ...
                    <Drawer.Content title={`Glass Drawer: ${size}`} size={size} glass>
                        <div style={{ padding: 'var(--space-4) 0', height: '100%', display: 'flex', flexDirection: 'column' }}>
                            <Flex direction="column" gap="4" height="100%">
                                <div>
                                    <Text as="p" size="2" color="gray" mb="3">
                                        This is a {size} glass drawer with the glassmorphism effect and improved layout.
                                    </Text>
                                    ...
                                    <div style={{
                                        ...
                                        <Text size="2" color="gray">Glass Content Area</Text>
                                    </div>
                                </div>
