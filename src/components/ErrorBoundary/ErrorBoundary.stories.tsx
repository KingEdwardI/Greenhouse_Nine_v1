...
export const Default: Story = () => (
  <div style={{ padding: "20px", background: "var(--gray-1)", minHeight: "400px" }}>
    <ErrorBoundary>
      <Box p="4">
        <Text>This content is wrapped in an ErrorBoundary and working normally.</Text>
      </Box>
    </ErrorBoundary>
  </div>
);
        ...
        <Card style={{ maxWidth: "400px", margin: "0 auto" }}>
          <Flex direction="column" gap="2" p="4" align="center">
            ...
            <Text size="2" color="gray">
              This is a custom fallback component instead of the default error boundary UI.
            </Text>
        ...
        <Box p="4">
          ...
          <Flex direction="column" gap="3">
            <SectionErrorBoundary sectionName="Section 1">
              <Box p="3" style={{ background: "var(--green-3)", borderRadius: "6px" }}>
                <Text>Section 1 - Working</Text>
              </Box>
            </SectionErrorBoundary>

            <SectionErrorBoundary sectionName="Section 2">
              <Box p="3" style={{ background: "var(--red-3)", borderRadius: "6px" }}>
                <ThrowError message="Section 2 error" />
              </Box>
            </SectionErrorBoundary>

            <SectionErrorBoundary sectionName="Section 3">
              <Box p="3" style={{ background: "var(--blue-3)", borderRadius: "6px" }}>
...
export const LongErrorMessage: Story = () => (
  <div style={{ padding: "20px", background: "var(--gray-1)", minHeight: "400px" }}>
    <ErrorBoundary>
      <ThrowError
        message="This is a very long error message that demonstrates how the error boundary handles lengthy error text. It includes technical details like stack traces, file paths, and other debugging information that might be quite verbose. The error boundary should display this in a scrollable container so the UI remains usable even with extensive error details. TypeError: Cannot read property 'map' of undefined at Component.render (component.tsx:45:12) at processChild (react-reconciler.js:234:5)"
      />
    </ErrorBoundary>
  </div>
);
