    ...
    <div style={{ display: "grid", gap: 16 }}>
      <div>
        <h2 style={{ margin: 0, marginBottom: 8 }}>
          Lucide Icons (suggested usage)
        </h2>
        <p style={{ margin: 0, color: "var(--gray-7)" }}>
          Install and import icons directly from <code>lucide-react</code>. This
          library does not bundle or re-export icons to keep bundles lean and
