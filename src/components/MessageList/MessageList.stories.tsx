  ...
  <div style={{ height: '400px', display: 'flex', flexDirection: 'column' }}>
    <MessageList>
      ...
      <Message variant="assistant" timestamp="9:01 AM">
        Good morning! I'd be happy to help you with questions about the project timeline. What specifically would you like to know?
      </Message>
      ...
      <Message variant="assistant" timestamp="9:04 AM">
        Based on our current progress, I estimate we should be ready for beta testing in about 2-3 weeks. We still need to complete the user authentication system and run thorough testing on the core features.
      </Message>
      ...
      <Message variant="assistant" timestamp="9:07 AM">
        ...
        1. Finalizing the database schema for user profiles
        2. Implementing OAuth integration for social login
        3. Setting up automated testing pipelines
        4. Performance optimization for the dashboard

        We're making good progress on items 1 and 3, but items 2 and 4 will need more focused attention this week.
      </Message>
      <Message variant="user" timestamp="9:10 AM" status="delivered">
        Thanks for the detailed breakdown. I'll check in with the team about prioritizing the OAuth work.
      </Message>
      <Message variant="user" timestamp="9:11 AM" status="sending">
        Let me know if you need any resources or support to move these items forward.
      </Message>
    </MessageList>
  </div>
);
  ...
  <div style={{ height: '400px', display: 'flex', flexDirection: 'column' }}>
    <MessageList showTyping={true} typingUsers={['Alice', 'Bob']}>
      ...
      <Message variant="assistant" timestamp="2:31 PM" username="Assistant">
        Yes, the meeting is still scheduled for 3 PM. I'll send out the agenda shortly.
      </Message>
...
export const EmptyState: Story = () => (
  <div style={{ height: '400px', display: 'flex', flexDirection: 'column' }}>
    <MessageList>
      {/* No messages - should show empty state */}
    </MessageList>
  </div>
);
...
export const CustomEmptyState: Story = () => (
  <div style={{ height: '400px', display: 'flex', flexDirection: 'column' }}>
    <MessageList emptyState={
      <div style={{ textAlign: 'center', padding: '60px 20px', color: 'var(--gray-9)' }}>
        <p style={{ fontSize: '18px', marginBottom: '8px' }}>Welcome to the chat!</p>
        <p style={{ fontSize: '14px' }}>Send your first message to get started.</p>
      </div>
    }>
...
export const ChatInterface: Story = () => (
  <div style={{ height: '500px', display: 'flex', flexDirection: 'column', border: '1px solid var(--gray-6)', borderRadius: '8px', overflow: 'hidden' }}>
    <div style={{ padding: '12px', borderBottom: '1px solid var(--gray-6)', background: 'var(--gray-2)' }}>
    ...
    <MessageList showTyping={true} typingUsers={['Assistant']}>
      ...
      <Message variant="assistant" timestamp="2:31 PM" username="Assistant">
        ...
        - **Message**: Individual message bubbles with user/system/assistant variants
        - **MessageList**: Container that handles scrolling and displays typing indicators  
        - **MessageInput**: Input area with auto-resize and keyboard shortcuts
        - **TypingIndicator**: Shows when others are typing
        
        Each component follows the same patterns as other components in this design system.
      </Message>
